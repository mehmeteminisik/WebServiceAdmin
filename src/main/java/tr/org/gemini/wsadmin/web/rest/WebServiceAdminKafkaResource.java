...
@RestController
@RequestMapping("/api/web-service-admin-kafka")
public class WebServiceAdminKafkaResource {
    private final Logger log = LoggerFactory.getLogger(WebServiceAdminKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebServiceAdminKafkaResource(KafkaProperties kafkaProperties) {
